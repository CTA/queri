...
describe Queri::Stats::IvrTracking::IvrTraversals, :focus do
  let(:report_class) { Queri::Stats::IvrTracking::IvrTraversals }
  ...
  describe "An instance of", Queri::Stats::IvrTracking::IvrTraversals do
