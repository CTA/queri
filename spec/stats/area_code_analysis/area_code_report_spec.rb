...
describe Queri::Stats::AreaCodeAnalysis::AreaCodeReport do
  let(:report_class) { Queri::Stats::AreaCodeAnalysis::AreaCodeReport }
  ...
  describe "An instance of", Queri::Stats::AreaCodeAnalysis::AreaCodeReport do
